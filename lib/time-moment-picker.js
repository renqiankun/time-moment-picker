  ...
  setup(M, { emit: z }) {
    ...
    let t = u.timeSeparator || ":", _ = f(() => parseFloat(u.maxHour) < 10 ? "0" + u.maxHour : u.maxHour), d = f(() => {
      ...
      for (let i = u.startMinute; i <= u.endMinute; i += u.minuteStep || 1)
        a.push(i < 10 ? "0" + i : i + "");
      return a;
    }), K = f(() => V.value[V.value.length - 1]), F = f(() => (a) => {
      var r, H, C, S, E, D, $, w, B;
      ...
      return i && s && !u.common ? `${a}${t}${K.value}` <= u.minTime : a < i;
    }), P = f(() => (a) => {
      var r, H, C, S, E, D, $, w, B;
  ...
  setup(M, { emit: z }) {
    ...
    he(
      ...
      () => {
        ...
        t.isRange ? (g.value = ((v = (m = (l = (e = t.modelValue) == null ? void 0 : e[0]) == null ? void 0 : l.split) == null ? void 0 : m.call(l, d)) == null ? void 0 : v[0]) ?? null, c.value = ((Y = (h = (p = (n = t.modelValue) == null ? void 0 : n[0]) == null ? void 0 : p.split) == null ? void 0 : h.call(p, d)) == null ? void 0 : Y[1]) ?? null, s.value = ((ee = (x = (A = (Z = t.modelValue) == null ? void 0 : Z[1]) == null ? void 0 : A.split) == null ? void 0 : x.call(A, d)) == null ? void 0 : ee[0]) ?? null, r.value = ((le = (ne = (O = (te = t.modelValue) == null ? void 0 : te[1]) == null ? void 0 : O.split) == null ? void 0 : ne.call(O, d)) == null ? void 0 : le[1]) ?? null) : (g.value = ((ue = (re = (j = t.modelValue) == null ? void 0 : j.split) == null ? void 0 : re.call(j, d)) == null ? void 0 : ue[0]) ?? null, c.value = ((ie = (ae = (q = t.modelValue) == null ? void 0 : q.split) == null ? void 0 : ae.call(q, d)) == null ? void 0 : ie[1]) ?? null, s.value = null, r.value = null), u == null || u.validate("change");
      }
    );
    let V = N(!1), K = f(() => {
      var e;
    ...
    const E = () => {
      ...
      V.value = !1;
      let e = "";
      t.isRange ? e = [H.value, C.value] : e = H.value, L("update:modelValue", e), B(), L("change");
    }, L = z;
    return (e, l) => {
      ...
      return y(), He(v, be({
        ...
        reference: T(() => {
          ...
          return [
            b("div", {
              class: J(["el-date-editor el-date-editor el-date-editor--timerange el-input__wrapper el-range-editor", { "is-active": o(V), "is-disabled": e.disabled }]),
              ...
              e.isRange ? (y(), R("span", Oe, G(e.rangeSeparator), 1)) : Q("", !0),
              e.isRange ? (y(), R("input", {
                key: 1,
...
}), ve = /* @__PURE__ */ X(Ke, [["__scopeId", "data-v-b4ab82c6"]]);
ve.install = (M) => {
